 ...
 module test_catapult::test_catapult {
    ...
    const COLLECTION_NAME :vector<u8> =(b"Penguins Surfer");
    const DESCRIPTION : vector<u8> =(b"Sui_Penguins is a collection of 666 Digitally created NFT use a DAO Mechanism Concept & Hold to Earn utility on Sui Network.");
    const COLLECTION_URI : vector<u8> =(b"https://linktr.ee/suipenguins/");
    const TOKEN_NAME : vector<u8> =(b"Penguins Surfer #");
    const TOKEN_URI : vector<u8> =(b"https://bafkreie6yjxlnhapqepphiqmxexduezwa47ckz5pmahzlsikozhtz2m5yu.ipfs.nftstorage.link/");
